    ...
    >
      ...
      <div className="relative z-10 flex flex-col md:flex-row w-full max-w-5xl h-auto md:h-[60vh] items-center justify-center p-6 md:p-0">
        ...
        <div className="w-full md:w-1/2 h-auto md:h-full flex flex-col justify-center items-center md:items-end md:pr-10 mb-8 md:mb-0">
            ...
            <p className="text-white/80 mt-2 text-base md:text-xl font-medium tracking-wide text-center md:text-right">To begin, click your user name</p>
        </div>
        ...
        <div className="w-full md:w-1/2 h-auto md:h-full flex flex-col justify-center items-center md:items-start md:pl-10">
          <motion.div
            className="flex flex-col md:flex-row items-center gap-4 group cursor-pointer p-4 rounded-xl hover:bg-white/10 transition"
            onClick={onLogin}
          ...
          >
            <div className="w-20 h-20 rounded-md overflow-hidden border-4 border-[#fff] shadow-xl group-hover:border-yellow-400 transition-colors">
              <img src={avatarImg} alt="Benziane Younes" className="w-full h-full object-cover" />
            </div>
            <div className="flex flex-col items-center md:items-start">
                <span className="text-2xl md:text-3xl text-white font-semibold drop-shadow-md tracking-tight group-hover:text-yellow-400 text-center md:text-left">Benziane Younes</span>
                <span className="text-xs md:text-sm text-white/70 italic mt-1 bg-[#1a4dc3] px-2 py-0.5 rounded max-w-max">Administrator</span>
            </div>
          </motion.div>
        </div>
      </div>
